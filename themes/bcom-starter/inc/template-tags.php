...
if ( ! function_exists( 'bcom_featured_image' ) ) :
/**
 * Display featured image when available.
 */
function bcom_featured_image() {
...
if ( ! function_exists( 'bcom_social_links' ) ) :
/**
...
if ( ! function_exists( 'bcom_posts_navigation' ) ) :
/**
 * Display navigation to next/previous set of posts when applicable.
 *
 * @todo Remove this function when WordPress 4.3 is released.
 */
function bcom_posts_navigation() {
...
if ( ! function_exists( 'bcom_post_navigation' ) ) :
/**
 * Display navigation to next/previous post when applicable.
 */
function bcom_post_navigation() {
...
if ( ! function_exists( 'bcom_posted_on' ) ) :
/**
 * Prints HTML with meta information for the current post-date/time and author.
 */
function bcom_posted_on() {
...
if ( ! function_exists( 'bcom_entry_footer' ) ) :
/**
 * Prints HTML with meta information for the categories, tags and comments.
 */
function bcom_entry_footer() {
 ...
 * @return bool
 */
function bcom_categorized_blog() {
	if ( false === ( $all_the_cool_cats = get_transient( 'bcom_categories' ) ) ) {
		...
		set_transient( 'bcom_categories', $all_the_cool_cats );
	}

	if ( $all_the_cool_cats > 1 ) {
		// This blog has more than 1 category so bcom_categorized_blog should return true.
		return true;
	} else {
		// This blog has only 1 category so bcom_categorized_blog should return false.
		return false;
	}
}

/**
 * Flush out the transients used in bcom_categorized_blog.
 */
function bcom_category_transient_flusher() {
	if ( defined( 'DOING_AUTOSAVE' ) && DOING_AUTOSAVE ) {
		return;
	}
	// Like, beat it. Dig?
	delete_transient( 'bcom_categories' );
}
add_action( 'edit_category', 'bcom_category_transient_flusher' );
add_action( 'save_post',     'bcom_category_transient_flusher' );
